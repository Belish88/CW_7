...
class Habit(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name='Автор', **NULL, related_name='owner')
    ...
    periodic = models.CharField(default=Periodic.DAY_1, max_length=2, choices=Periodic.choices, verbose_name='Периодичность', **NULL)
